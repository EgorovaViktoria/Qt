...
KeyBoard::KeyBoard(const int width, QWidget* parent)
    ...
    connect(backspace_btn, &KeyBoardButton::clickedWithText, this, &KeyBoard::onButtonClicked);
    ...
    connect(right_shift_btn, &KeyBoardButton::clickedWithText, this, &KeyBoard::onButtonClicked);
    ...
    connect(space, &KeyBoardButton::clickedWithText, this, &KeyBoard::onButtonClicked);
}
